...
public class NearByDeviceDBHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_4 = "DiscoveredAt";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT,NearbyDeviceIdentifer TEXT,PhoneNumber TEXT,DiscoveredAt TEXT)");
    }
    ...
    public boolean insertData(String nearbyDevice, String phoneNumber, String discoveredAt) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_2, nearbyDevice);
        contentValues.put(COL_3, phoneNumber);
        contentValues.put(COL_4, discoveredAt);
